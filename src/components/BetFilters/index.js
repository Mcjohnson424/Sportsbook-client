...
export default function BetFilters() {
  ...
  return (
    <Accordion>
      <Row>
        <Col lg={2} md={3} sm={12} sx={12}>
          <CustomToggle eventKey="0" />
        </Col>

        <Col lg={2} md={3} sm={12} sx={12}>
          <h3 className="font-weight-bold">Active filters:</h3>
        </Col>
        {filters.startDate && filters.endDate && (
          <Col lg={2} md={3} sm={6} sx={12} className="p-2 bg-success m-1">
        ...
        {Object.keys(filters)
          ...
          .map((key) => (
            <Col lg={2} md={3} sm={4} sx={12} className="p-2 bg-success m-1">
              {key === "status_id" ? (
                <>
                  {
